//
// circle_syscalls.cpp — Cannonball's file access, routed to the core that
// owns the hardware.
//
// THE PROBLEM. Cannonball reads its ROMs, its resources and its config
// with plain C++: std::ifstream, opendir/readdir, remove(). Those reach
...
// interrupts included, belongs to core 0. Cannonball has no file layer of
