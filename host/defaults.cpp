...
//     cannonball-defaults.ld pins to image offset 0x800. It ships with the
...
#ifdef __ELF__
__asm__ (
    "\t.section .cannonball.entry, \"ax\", %progbits\n"
    "\t.globl _cannonball_entry\n"
    "_cannonball_entry:\n"
    "\tb _start\n"
    "\t.previous\n"
);
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".cannonball.defaults"), used, aligned (8)))
#else
...
TDefaultsBlock _cannonball_defaults =
{
